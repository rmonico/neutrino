...
public class TestCompleteSourceFileParsing extends RefactoringAbstractTests {
	...
	private void prepareTests() throws JavaModelException {
		...
		knownAnnotationSource.append("package org.ita.neutrino.otherpackage;\n");
		knownAnnotationSource.append("\n");
		knownAnnotationSource.append("public @interface KnownAnnotation {\n");
		knownAnnotationSource.append("\n");
		knownAnnotationSource.append("}\n");

		compilationUnits[0] = createSourceFile("org.ita.neutrino.otherpackage", "KnownAnnotation.java", knownAnnotationSource);

		StringBuilder knownClassSource = new StringBuilder();

		knownClassSource.append("package org.ita.neutrino.otherpackage;\n");
		knownClassSource.append("\n");
		knownClassSource.append("public class KnownClass {\n");
		knownClassSource.append("\n");
		knownClassSource.append("}\n");

		compilationUnits[1] = createSourceFile("org.ita.neutrino.otherpackage", "KnownClass.java", knownClassSource);

		StringBuilder knownExceptionSource = new StringBuilder();

		knownExceptionSource.append("package org.ita.neutrino.otherpackage;\n");
		...
		compilationUnits[2] = createSourceFile("org.ita.neutrino.otherpackage", "KnownException.java", knownExceptionSource);
		...
		publicClassSource.append(" */\n");
		publicClassSource.append("\n");
		publicClassSource.append("package org.ita.neutrino.testfiles;\n");
		publicClassSource.append("\n");
		publicClassSource.append("import org.ita.neutrino.otherpackage.KnownAnnotation;\n");
		publicClassSource.append("import org.ita.neutrino.otherpackage.KnownException;\n");
		publicClassSource.append("import org.ita.neutrino.otherpackage.KnownClass;\n");
		publicClassSource.append("\n");
		...
		compilationUnits[3] = createSourceFile("org.ita.neutrino.testfiles", "PublicClass.java", publicClassSource);
	}
	...
	public void testCompleteSourceFileParsing() throws JavaModelException, ParserException {
		...
		ASTPackage testfilesPackage = (ASTPackage) environment.getPackageList().get("org.ita.neutrino.testfiles");
	...
	private void testClassModifierParsing() {
		...
		assertEquals("ASTClass: Propriedade parent", environment.getTypeCache().get("org.ita.neutrino.otherpackage.KnownClass"), fullClass.getSuperClass());
	...
	private void testAnnotationParsing() {
		...
		assertEquals("Lista de anotações: conteúdo", environment.getTypeCache().get("org.ita.neutrino.otherpackage.KnownAnnotation"), nonDummyAnnotated.getAnnotations().get(0));
	}
