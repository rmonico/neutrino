...
public class ExtractFinalizationMethodJUnit3Tests extends ExtractFinalizationMethodTests {
	...
	protected void prepareTests() throws JavaModelException, ParserException, TestParserException {
		...
		refactoredCompilationUnit = createSourceFile("org.ita.neutrino.extractfinalizationmethod", "TestConnectJUnit3.java", beforeRefactoringSource);
		...
		selection.setSelectionStart(100);
